package ml.karmaconfigs.locklogin.api.encryption.libraries.argon.algorithm;

import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Constants;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Util;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Argon2Type;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Block;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Instance;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Position;

import static ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Constants.ARGON2_ADDRESSES_IN_BLOCK;
import static ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Constants.ARGON2_VERSION_10;
