package ml.karmaconfigs.locklogin.api.encryption.argon.util.model;

import ml.karmaconfigs.locklogin.api.encryption.argon.util.Util;

import java.util.Arrays;

import static ml.karmaconfigs.locklogin.api.encryption.argon.util.Constants.ARGON2_BLOCK_SIZE;
import static ml.karmaconfigs.locklogin.api.encryption.argon.util.Constants.ARGON2_QWORDS_IN_BLOCK;
