...
import ml.karmaconfigs.locklogin.api.encryption.argon.util.Constants;
import ml.karmaconfigs.locklogin.api.encryption.argon.util.Util;
...
import ml.karmaconfigs.locklogin.api.encryption.argon.util.model.Position;

import static ml.karmaconfigs.locklogin.api.encryption.argon.util.Constants.ARGON2_ADDRESSES_IN_BLOCK;
import static ml.karmaconfigs.locklogin.api.encryption.argon.util.Constants.ARGON2_VERSION_10;
