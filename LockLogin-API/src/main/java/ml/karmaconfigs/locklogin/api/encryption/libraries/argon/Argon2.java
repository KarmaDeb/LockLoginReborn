package ml.karmaconfigs.locklogin.api.encryption.libraries.argon;

import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.algorithm.FillMemory;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.algorithm.Finalize;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.algorithm.Initialize;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Argon2Type;
import ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Instance;
...
import static ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Constants.Defaults.*;
import static ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Util.clearArray;
import static ml.karmaconfigs.locklogin.api.encryption.libraries.argon.Util.toByteArray;
import static ml.karmaconfigs.locklogin.api.encryption.libraries.argon.model.Argon2Type.*;
...
public class Argon2 {
    ...
    public Argon2Result hash(char[] password, String salt, Charset charset) {
        password(toByteArray(password, charset));
