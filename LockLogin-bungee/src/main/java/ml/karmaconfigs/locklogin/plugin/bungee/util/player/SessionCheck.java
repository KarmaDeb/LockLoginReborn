...
public final class SessionCheck implements Runnable {
    ...
    private final Consumer<ProxiedPlayer> authAction;
    private final Consumer<ProxiedPlayer> failAction;
     ...
     */
    public SessionCheck(final ProxiedPlayer target, final Consumer<ProxiedPlayer> onAuth, final Consumer<ProxiedPlayer> onFail) {
        player = target;
        authAction = onAuth;
        failAction = onFail;
    }
